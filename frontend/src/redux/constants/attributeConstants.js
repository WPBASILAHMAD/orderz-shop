...
export const ATTRIBUTE_FETCH_REQUEST = "ATTRIBUTE_FETCH_REQUEST";
export const ATTRIBUTE_FETCH_SUCCESS = "ATTRIBUTE_FETCH_SUCCESS";
export const ATTRIBUTE_FETCH_FAIL = "ATTRIBUTE_FETCH_FAIL";
